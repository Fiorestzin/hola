...
export default function SettingsPanel({ isOpen, onClose, token, embedded = false }) {
    ...
    const Content = (
        <div className={`${embedded ? 'h-full flex flex-col' : 'bg-slate-800 border border-slate-700 rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden flex flex-col max-h-[90vh]'}`}>
